...
printf("%s\n",*message);}else{if(m > 1 && m < 5){*message = "level 3.2";
printf("%s\n",*message);}else{*message = "level 3.3";
printf("%s\n",*message);}}printf("%s\n",*message);}else{*message = "level 2.2";
if(m <= 1){*message = "level 3.4";
printf("%s\n",*message);}else{if(m > 1 && m < 5){*message = "level 3.5";
printf("%s\n",*message);}else{*message = "level 3.6";
printf("%s\n",*message);}}printf("%s\n",*message);}printf("%s\n",*message);}
...
while(k >= 1){
{printf("%s","Inserisci n: ");scanf("%d", &n);getchar();printf("%s","Inserisci m: ");scanf("%d", &m);getchar();printf("%s%d%s%d\n","I valori inseriti sono ",n," e ",m);scoping_fun(n, m, &message);
k = k - 1;
}
}
